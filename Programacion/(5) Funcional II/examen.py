...
tomar_mientras = lambda f , t: () if t == () else () if not f(f(0)) else (t[0],) + tomar_mientras(f, t[1:])
quitar_mientras = lambda f , t: () if t == () else t if not f(f(0)) else (t[0],) + quitar_mientras(f, t[1:])
